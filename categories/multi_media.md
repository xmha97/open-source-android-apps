...
| [**AntennaPod**](https://github.com/AntennaPod/AntennaPod) | A powerful and flexible podcast manager for Android. | `Java` | `GPL-3.0` | 8.1k | [![Google Play](https://upload.wikimedia.org/wikipedia/commons/7/78/Google_Play_Store_badge_EN.svg)](https://play.google.com/store/apps/details?id=de.danoeh.antennapod) |
...
| [**Blazify**](https://github.com/rajendra7169/blazify) | A music player that streams online and plays the files already on your phone, with synced lyrics and a ten-band equalizer. | `Kotlin` | `GPL-3.0` | 28 | [![Download](https://img.shields.io/badge/Download-Releases-blue)](https://github.com/rajendra7169/blazify) |
...
| [**Kafka for Internet Archive**](https://github.com/vipulyaara/Kafka) | A modern client for Internet Archive with a built-in reader and audio player. | `Kotlin` | `GPL-3.0` | 394 | — |
