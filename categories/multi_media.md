...
| [**ad-free**](https://github.com/abertschi/ad-free) | A proof-of-concept modular audio ad-blocker for Android. | `Kotlin` | `Apache-2.0` | 298 | [![F-Droid](https://f-droid.org/badge/get-it-on.svg)](https://f-droid.org/packages/ch.abertschi.adfree) |
...
| [**AntennaPod**](https://github.com/AntennaPod/AntennaPod) | A powerful and flexible podcast manager for Android. | `Java` | `GPL-3.0` | 8.2k | [![Google Play](https://upload.wikimedia.org/wikipedia/commons/7/78/Google_Play_Store_badge_EN.svg)](https://play.google.com/store/apps/details?id=de.danoeh.antennapod) |
...
| [**Auro**](https://github.com/architjn/Auro) | A fast, modern, open-source music player for Android. | `Java` | `GPL-3.0` | 785 | — |
| [**Aves**](https://github.com/deckerst/aves) | A gallery and metadata explorer app built for Android with Flutter. | `Dart` | `BSD-3-Clause` | 5.3k | [![Google Play](https://upload.wikimedia.org/wikipedia/commons/7/78/Google_Play_Store_badge_EN.svg)](https://play.google.com/store/apps/details?id=deckers.thibault.aves) |
...
| [**Blazify**](https://github.com/rajendra7169/blazify) | A music player that streams online and plays the files already on your phone, with synced lyrics and a ten-band equalizer. | `Kotlin` | `GPL-3.0` | 36 | [![Download](https://img.shields.io/badge/Download-Releases-blue)](https://github.com/rajendra7169/blazify) |
...
| [**CloudStream**](https://github.com/recloudstream/cloudstream) | An Android app for streaming and downloading movies, TV shows, and anime. | `Kotlin` | `GPL-3.0` | 10.7k | — |
...
| [**Jellyfin**](https://github.com/jellyfin/jellyfin-android) | The official Android client for the Jellyfin media server. | `Kotlin` | `GPL-2.0` | 2.8k | [![Google Play](https://upload.wikimedia.org/wikipedia/commons/7/78/Google_Play_Store_badge_EN.svg)](https://play.google.com/store/apps/details?id=org.jellyfin.mobile) |
| [**Kafka for Internet Archive**](https://github.com/vipulyaara/Kafka) | A modern client for Internet Archive with a built-in reader and audio player. | `Kotlin` | `GPL-3.0` | 396 | — |
...
| [**Material Audiobook Player**](https://github.com/PaulWoitaschek/Voice) | A feature-rich audiobook player designed for Android. | `Kotlin` | `GPL-3.0` | 3.1k | [![Google Play](https://upload.wikimedia.org/wikipedia/commons/7/78/Google_Play_Store_badge_EN.svg)](https://play.google.com/store/apps/details?id=de.ph1b.audiobook) |
...
| [**Music DNA**](https://github.com/harjot-oberai/MusicDNA) | A music player that renders a beautiful DNA-like visualization of the music. | `Java` | `Apache-2.0` | 2.8k | — |
| [**NewPipe**](https://github.com/TeamNewPipe/NewPipe) | A lightweight, privacy-friendly YouTube frontend for Android. | `Java` | `GPL-3.0` | 39.7k | [![F-Droid](https://f-droid.org/badge/get-it-on.svg)](https://f-droid.org/packages/org.schabi.newpipe) |
| [**NOVA Video Player**](https://github.com/nova-video-player/aos-AVP) | A video player for local/network content with subtitle/metadata support. | `HTML` | `Apache-2.0` | 4.7k | [![Google Play](https://upload.wikimedia.org/wikipedia/commons/7/78/Google_Play_Store_badge_EN.svg)](https://play.google.com/store/apps/details?id=org.courville.nova) |
| [**Nuvio**](https://github.com/NuvioMedia/NuvioMobile) | A modern media hub for Android and iOS built with Kotlin Multiplatform and Compose Multiplatform. | `Kotlin` | `GPL-3.0` | 3.5k | [![Google Play](https://upload.wikimedia.org/wikipedia/commons/7/78/Google_Play_Store_badge_EN.svg)](https://play.google.com/store/apps/details?id=com.nuvio.app) |
...
| [**Podverse**](https://github.com/podverse/podverse-rn) | A feature-rich, cross-platform podcast app with a focus on clip sharing. | `TypeScript` | `AGPL-3.0` | 286 | [![Google Play](https://upload.wikimedia.org/wikipedia/commons/7/78/Google_Play_Store_badge_EN.svg)](https://play.google.com/store/apps/details?id=com.podverse) |
| [**QuickNovel**](https://github.com/LagradOst/QuickNovel) | An ad-free, FOSS app for downloading novels and reading them as Epubs. | `Kotlin` | `GPL-3.0` | 1.8k | — |
| [**Retro Music Player**](https://github.com/RetroMusicPlayer/RetroMusicPlayer) | A beautiful, customizable music player that follows Material You design. | `Kotlin` | `GPL-3.0` | 5.3k | [![Google Play](https://upload.wikimedia.org/wikipedia/commons/7/78/Google_Play_Store_badge_EN.svg)](https://play.google.com/store/apps/details?id=code.name.monkey.retromusic) |
| [**SeriesGuide**](https://github.com/UweTrottmann/SeriesGuide) | Helps you manage and track your favorite TV shows and movies. | `Kotlin` | `Apache-2.0` | 2.2k | [![Google Play](https://upload.wikimedia.org/wikipedia/commons/7/78/Google_Play_Store_badge_EN.svg)](https://play.google.com/store/apps/details?id=com.battlelancer.seriesguide) |
| [**Showly**](https://github.com/trakt/showly) | A modern, slick, open-source TV show tracker for Android. | `Kotlin` | `GPL-3.0` | 1.5k | [![Google Play](https://upload.wikimedia.org/wikipedia/commons/7/78/Google_Play_Store_badge_EN.svg)](https://play.google.com/store/apps/details?id=com.michaldrabik.showly2) |
...
| [**TrimPlayer**](https://github.com/yonatanholdings/TrimPlayer) | A podcast player that automatically skips intros, ads and outros by detecting audio that repeats across a show's episodes. | `Java` | `GPL-3.0` | 1 | [![Google Play](https://upload.wikimedia.org/wikipedia/commons/7/78/Google_Play_Store_badge_EN.svg)](https://play.google.com/store/apps/details?id=com.trimplayer) |
...
| [**Vanilla Music**](https://github.com/vanilla-music/vanilla) | A clean, simple, and free open-source music player. | `Java` | `GPL-3.0` | 1.4k | — |
| [**VLC for Android**](https://github.com/videolan/vlc-android) | The official port of the versatile, open-source VLC media player. | `Kotlin` | `GPL-2.0` | 4.0k | [![Google Play](https://upload.wikimedia.org/wikipedia/commons/7/78/Google_Play_Store_badge_EN.svg)](https://play.google.com/store/apps/details?id=org.videolan.vlc) |
