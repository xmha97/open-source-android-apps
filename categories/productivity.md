...
| [**Expanda**](https://github.com/diegomarzaa/expanda) | Offline text expansion with reusable snippets and dynamic templates, without Internet permission. | `Kotlin` | `GPL-3.0` | 37 | [GitHub Releases](https://github.com/diegomarzaa/expanda) |
...
| [**KashCal**](https://github.com/KashCal/KashCal) | An offline-first calendar with iCloud/CalDAV sync, ICS subscriptions, full-text search, and home-screen widgets. | `Kotlin` | `Apache-2.0` | 412 | [![F-Droid](https://f-droid.org/badge/get-it-on.svg)](https://f-droid.org/packages/org.onekash.kashcal) |
...
| [**MarkNote**](https://github.com/Shouheng88/MarkNote) | A Material Design Markdown note-taking application for Android. | `Java` | `AGPL-3.0` | 919 | [![Download](https://img.shields.io/badge/Download-APK-blue)](https://www.coolapk.com/apk/178276) |
...
| [**Nudge**](https://github.com/astraedus/nudge) | A privacy-first ADHD app blocker with delay-to-open friction, reel/click counters, and per-app time budgets. No internet permission required. | `Kotlin` | `GPL-3.0` | 32 | [![Google Play](https://upload.wikimedia.org/wikipedia/commons/7/78/Google_Play_Store_badge_EN.svg)](https://play.google.com/store/apps/details?id=dev.astraedus.nudge) |
...
| [**Read Later**](https://github.com/sak96/read_later) | Bookmark. Read. Listen. The simple way to manage your reading list. | `Rust` | `MIT` | 60 | [![IzzyOnDroid](https://countdate.sk5s.com/assets/img/IzzyOnDroid.png)](https://apt.izzysoft.de/packages/io.github.sak.read.it.later) [![Google Play](https://upload.wikimedia.org/wikipedia/commons/7/78/Google_Play_Store_badge_EN.svg)](https://play.google.com/store/apps/details?id=io.github.sak.read.it.later) [![GitHub](https://raw.githubusercontent.com/Kunzisoft/Github-badge/main/get-it-on-github.png)](https://github.com/sak96/read_later) [![OpenAPK](https://www.openapk.net/images/openapk-badge.png)](https://www.openapk.net/read-later/io.github.sak.read.it.later/) |
