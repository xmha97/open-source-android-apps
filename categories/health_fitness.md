...
| [**OpenHearing**](https://github.com/HMAKT99/OpenHearing) | Checks your hearing, builds a personal per-ear sound profile, and amplifies quiet sound in real time on any earbuds. | `Kotlin` | `GPL-3.0` | 16 | — |
...
| [**trale**](https://github.com/QuantumPhysique/trale) | A simple and privacy-respecting body weight diary app built with Flutter. | `Dart` | `AGPL-3.0` | 206 | — |
